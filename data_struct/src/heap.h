 ...
 *
 * This heap implementation uses a dinamically allocated array, but its size is fixed to the number
...
#define SIZE_HEAP (2*sizeof(int) + 2*sizeof(int *))
